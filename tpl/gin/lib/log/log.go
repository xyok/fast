...
func (logger *Logger) Print(format string, a ...interface{}) {
	logger.doPrintf(infoLevel, "", format, a...)
}

var gLogger, _ = New("debug", "", log.Ldate|log.Lmicroseconds|log.Lshortfile)
...
func NewReqLogger() *Logger {
	logger, _ := New("debug", "", log.Ldate|log.Ltime)
	return logger
}
